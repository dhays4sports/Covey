...
check('release advances to CoverageFit 3.20.54', ['3.20.54','3.20.55','3.20.56','3.20.57','3.20.58','3.20.59','3.20.60'].includes(fs.readFileSync('VERSION', 'utf8').trim()) && JSON.parse(fs.readFileSync('package.json', 'utf8')).version === fs.readFileSync('VERSION', 'utf8').trim());
